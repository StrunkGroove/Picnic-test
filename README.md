...
#### Решение
 - Разделение серверов по городам для уменьшения кол. запросов с одного IP.
 - Использование прокси и управление несколькими API-ключами.
 - Автоматическое обновление данных погоды в базе данных (Redis, (In-Momery databse)) с частым обновлением для обеспечения актуальности данных (Celery).
