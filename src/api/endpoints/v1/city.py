...
@router.post('/city/append/', summary='Append City', response_model=CitiesOneResponse, description='Добавление города по его названию')
...
@router.get('/city/info/', summary='Get Citiy', response_model=CitiesInfoResponse, description='Получение информации о городе')
